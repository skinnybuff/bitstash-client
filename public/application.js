...
var indexFiles = __webpack_require__(19);
var showFile = __webpack_require__(36);
var emptyFileList = __webpack_require__(37);

var userMessageBox = function userMessageBox(xField, xText, xColor, xTime) {
  $(xField).text(xText);
...
var formatDateUS = function formatDateUS(file, idToChange) {
  var createdDate = new Date(file.createdAt);
  var formatCreateDate = createdDate.toLocaleString('en-US');
  // console.log('formatCreateDate is:', formatCreateDate)
  $(idToChange + file.id).text(formatCreateDate);
};

var createFileSuccess = function createFileSuccess(data) {
  if (data.special_message) {
    ...
    var singleFileHTML = showFile({ file: data.file });
...
var updateFileSuccess = function updateFileSuccess(data) {
...
var updateFileFailure = function updateFileFailure(data) {
  userMessageBox('.uiFeedback', 'Error updating file', '#bf6d20', 6000);
  // console.log(error)
};

var deleteFileSuccess = function deleteFileSuccess(data) {
...
var deleteFileFailure = function deleteFileFailure(data) {
...
module.exports = {
  ...
  createFileSuccess: createFileSuccess,
  createFileFailure: createFileFailure,
  getAllFilesSuccess: getAllFilesSuccess,
  getAllFilesFailure: getAllFilesFailure,
  // getOneFileSuccess,
  // getOneFileFailure,
  updateFileSuccess: updateFileSuccess,
  updateFileFailure: updateFileFailure,
  deleteFileSuccess: deleteFileSuccess,
  deleteFileFailure: deleteFileFailure
};
...
var getAllFiles = function getAllFiles(data) {
...
var getOneFile = function getOneFile(data) {
  return $.ajax({
...
var fileEvents = __webpack_require__(38);
...
var filesAPI = __webpack_require__(10);
var filesUI = __webpack_require__(5);
...
var onSignIn = function onSignIn(event) {
  ...
  // console.log(data)
  event.preventDefault();
  api.signIn(data).then(ui.signInSuccess).then(filesAPI.getAllFiles).then(filesUI.getAllFilesSuccess).catch(ui.signInFailure);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"panel-group accordion\" id=\"container-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <div class=\"panel panel-default \">\n        <div class=\"panel-heading\">\n          File Name: &nbsp;\n            <h1 class=\"panel-title\">\n                <a data-toggle=\"collapse\"  href=\"#panel-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" id=\"name-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.file_name : stack1), depth0))
    + "<span class=\"caret\"></span></a>\n            </h1>\n                <span class=\"accordian-head-btns\">\n                  <a class=\"view-btn\" href=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "\" target=\"_blank\">View</a>\n                  <a class=\"download-btn\" href=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.url : stack1), depth0))
    + "\" download>Download</a>\n                </span>\n            <p data-type=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.file_type : stack1), depth0))
    + "\">File Type: &nbsp;&nbsp;<b>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.file_type : stack1), depth0))
    + "</b></p>\n        </div>\n        <div id=\"panel-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"panel-collapse collapse\">\n            <div class=\"panel-body\">\n              <p data-size=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.file_size : stack1), depth0))
    ...
    + "\"><h4>Date Stored: </h4><span id=\"created-time-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.createdAt : stack1), depth0))
    + "</span> </p>\n              <p><h4>Change Name: </h4><input type=\"text\" name=\"file[name]\" placeholder=\"New Name Here\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                <button type=\"button\" class=\"btn btn-default update-file-btn\" data-file-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"> Update </button>\n              </p>\n              <button type=\"button\" class=\"btn btn-default remove-file-btn\" data-file-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"> Remove </button>\n            </div>\n        </div>\n    </div>\n</div>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.files : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"panel-group accordion\" id=\"container-"
    ...
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.file_name : stack1), depth0))
    + "<span class=\"caret\"></span></a>\n            </h1>\n                <span class=\"accordian-head-btns\">\n                  <a class=\"view-btn\" href=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.url : stack1), depth0))
    + "\" target=\"_blank\">View</a>\n                  <a class=\"download-btn\" href=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.url : stack1), depth0))
    + "\" download>Download</a>\n                </span>\n            <p data-type=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.file_type : stack1), depth0))
    + "\">File Type: &nbsp;&nbsp;<b>"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.file_type : stack1), depth0))
    + "</b></p>\n        </div>\n        <div id=\"panel-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.id : stack1), depth0))
    + "\" class=\"panel-collapse collapse\">\n            <div class=\"panel-body\">\n              <p data-size=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.file_size : stack1), depth0))
    + "\"><h4>File Size (Bytes): </h4> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.file_size : stack1), depth0))
    + " </p>\n              <p data-tags=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.tags : stack1), depth0))
    + "\"><h4>File Tags: </h4> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.tags : stack1), depth0))
    + " </p>\n              <p data-url=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.url : stack1), depth0))
    ...
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.url : stack1), depth0))
    + " </p>\n              <p data-createdAt=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.createdAt : stack1), depth0))
    + "\"><h4>Date Stored: </h4><span id=\"created-time-"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.id : stack1), depth0))
    + "\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.file : depth0)) != null ? stack1.createdAt : stack1), depth0))
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"empty-files-msg\">\n  <h1>\n    Welcome!\n  </h1>\n  <h2>\n    Start uploading to Stash your Bits\n  </h2>\n</div>\n";
},"useData":true});
...
var onCreateFile = function onCreateFile(event) {
  event.preventDefault();
  ...
  .then(ui.createFileSuccess).catch(ui.createFileFailure);
};

var onGetAllFiles = function onGetAllFiles(event) {
  event.preventDefault();
  // console.log('this is the event.target', event.target)
  var data = getFormFields(event.target);
  api.getAllFiles(data).then(ui.getAllFilesSuccess).catch(ui.getAllFilesFailure);
};

var onGetOneFile = function onGetOneFile(event) {
  event.preventDefault();
  // console.log('this is the event.target', event.target)
  var data = getFormFields(event.target);
  api.getOneFile(data).then(ui.getOneFileSuccess).catch(ui.getOneFileFailure);
};

var searchForFile = function searchForFile(fileDataObj) {
  var foundObject = void 0;
  store.files.find(function (element) {
...
var onUpdateFile = function onUpdateFile(event) {
  ...
  var fileData = searchForFile(searchObject);
  // console.log('this is the fileData', fileData)
  // console.log('store files:', store.files)

  // This the new name for the file
  var newName = $('#' + searchObject.id).val();
  console.log('newName is:', newName);
  if (newName) {
    fileData.file_name = newName;
    api.updateFile(fileData).then(ui.updateFileSuccess).catch(ui.updateFileFailure);
  } else {
    event.preventDefault();
...
var onDeleteFile = function onDeleteFile(event) {
  ...
  var itemToDelete = function itemToDelete(fileId) {
    var foundObject = void 0;
    store.files.find(function (element) {
    ...
    var indexOfFile = store.files.indexOf(foundObject);
    store.files.splice(indexOfFile, 1);
  };
  // console.log(itemToDelete(deleteFileId))
  // console.log('This is the entire store: ', store)
  // console.log($(this).closest('tr'))
  api.deleteFile(deleteFileId).then(function (dummyData) {
    return itemToDelete(deleteFileId);
  }).then(ui.deleteFileSuccess).catch(ui.deleteFileFailure);
};
